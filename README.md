...
 等网页加载完成以后我们就可以使用第二个按钮了</br>
 ...
      如果这个demo帮助到你了，请你给版主一个star谢谢，版主还是一个android菜鸟 希望和大家共同学习下面是我的QQ二维码 欢迎大家骚扰和我一起学习 ![](https://github.com/xuwei1995/EventBusXTest/blob/master/app/src/main/java/xuwei/com/eventbusxtest/gif/erweimaqq.png?raw=true)
